...
- PSD text layer bounds are often visible glyph bounds rather than a generous CSS text box. Semantic single-line text must therefore disable automatic wrapping and local clipping; otherwise a small font-metric difference at the design width becomes truncated characters after responsive scaling.
